    ...
    return (
        <div className="app-card overflow-hidden">
            <div className="px-5 py-4 border-b border-app-border flex items-center justify-between">
                <h3 className="text-base font-bold text-brand-dark">Live Activity</h3>
            ...
            <div className="divide-y divide-app-border max-h-[400px] overflow-y-auto app-scrollbar">
                {items.map((item) => (
                    <div
                        key={item.id}
                        className="flex items-start gap-3 px-5 py-4 hover:bg-brand-surface/50 transition-colors"
                    >
                        <div className="p-2 rounded-xl bg-brand-surface border border-app-border flex-shrink-0 mt-0.5">
