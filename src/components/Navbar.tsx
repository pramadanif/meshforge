    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-brand-primary text-brand-dark px-6 py-2.5 rounded-full font-bold text-sm hover:bg-white hover:scale-105 transition-all flex items-center gap-2">
              Launch App
              <ArrowRight size={16} />
            </button>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-brand-dark border-t border-white/10 shadow-2xl px-4 py-6 flex flex-col space-y-4">
           ...
           <button className="bg-brand-primary text-brand-dark w-full py-4 rounded-xl font-bold mt-4">
              Launch App
           </button>
        </div>
      )}
